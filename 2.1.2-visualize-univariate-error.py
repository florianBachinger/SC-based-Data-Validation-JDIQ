...
for equation in equations:
  ...
  for current_variable in equation['Variables']:
    ...
    for error_config in ['NONE', 'Square','Spike','RampUp','RampDown','ExponentialUp','Normal']:
      ...
      print(f"{equation_name.ljust(10)} {varied_variable_name.ljust(8)} {variable_constraints['name'].ljust(8)} {error_config.ljust(14)} " 
